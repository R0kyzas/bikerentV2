                    ...
                    <div className="relative bg-white rounded-lg shadow">
                        ...
                        <div className="pt-1">
                            <p className="text-base font-bold leading-relaxed text-gray-500">
                                Date:{" "}
                                <span className="text-base font-medium leading-relaxed text-gray-500">
                                    {saveConverted}
                                </span>
                            </p>
                        </div>
    ...
    if (status === "Pending") {
        return (
            <>
                ...
                <button
                    className="text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-red-700 hover:bg-red-800"
                    onClick={() => handleShow(setCancelID(itemId))}
                >
                    Cancel
                </button>
            </>
        ...
        return (
            <>
                <button
                    className="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                    onClick={showCancelDetailsModal}
                >
                    Cancel details
                </button>
...
export default AdminOrderStatusHandle;